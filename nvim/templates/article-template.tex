...
\titlespacing*{\section}
{0pt}             % Linker Abstand
{0.5cm}           % Abstand vor dem Abschnitt
{0.3cm}           % Abstand nach dem Abschnitt
{0pt}             % Linker Abstand
{0.5cm plus 0.1cm minus 0.05cm} % Abstand vor dem Abschnitt
{0.3cm plus 0.1cm minus 0.05cm} % Abstand nach dem Abschnitt
%========================== KOPF - UND FUßZEILE ============================
