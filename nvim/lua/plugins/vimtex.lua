...
--     -- vim.api.nvim_set_keymap('n', '<Localleader>c', ':lua CleanLatexFiles()<CRG>', { noremap = true, silent = true })
--   end,
-- }
--
...
return {
  ...
  config = function()
    ...
    vim.api.nvim_set_keymap("n", "<Localleader>vC", ":VimtexClear!<CR>", { noremap = true, silent = true })
