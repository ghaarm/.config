...
-- https://github.com/linkarzu/dotfiles-latest/blob/4ac00c8653025da331d43adfb892dc7a67ea4c6a/neovim/nvim-lazyvim/lua/plugins/image-nvim.lua
--
...
--             only_render_image_at_cursor = true,
--
--             -- pandoc ergänzen, falls du deine Markdown-Dateien als
--             -- filetype=pandoc verwendest
--             filetypes = {
--               "markdown",
--               "pandoc",
--               "vimwiki",
...
return {
  {
    ...
    config = function()
      ...
      -- Bilder bei Bedarf ein-/ausschalten
      vim.keymap.set("n", "<localleader>io", function()
        if image.is_enabled() then
          image.disable()
          vim.notify("Image Preview: OFF")
        else
          image.enable()
          vim.notify("Image Preview: ON")
        end
      end, {
        noremap = true,
        silent = true,
