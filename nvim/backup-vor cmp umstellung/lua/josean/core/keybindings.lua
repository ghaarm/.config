...
function M.setup_coc_keybindings()
  local keyset = vim.keymap.set
  local opts = { silent = true, noremap = true, expr = true, replace_keycodes = false }

  -- Keybindings für das Navigieren in der Vervollständigungspopup
...
-- nächstes Plugin
--
-- function M.setup_example_plugin_keybindings()
--   local keyset = vim.keymap.set
--   local opts = { silent = true, noremap = true, expr = true, replace_keycodes = false }
--
--   -- Beispiel-Keybindings für ein anderes Plugin
--   keyset("n", "<leader>e", ":ExampleCommand<CR>", opts)
--   keyset("i", "<F5>", ":ExampleInsertModeCommand<CR>", opts)
-- end
